...
aws s3 cp ./artifacts/CreateYouTubeLinksFunction.zip s3://conway-build-artifacts/zerotube/CreateYouTubeLinksFunction/CreateYouTubeLinksFunction_${VERSION}.zip
aws s3 cp ./artifacts/GetRandomYouTubeLinkFunction.zip s3://conway-build-artifacts/zerotube/GetRandomYouTubeLinkFunction/GetRandomYouTubeLinkFunction_${VERSION}.zip
aws s3 cp ./artifacts/CleanupYouTubeLinksFunction.zip s3://conway-build-artifacts/zerotube/CleanupYouTubeLinksFunction/CleanupYouTubeLinksFunction_${VERSION}.zip
